  ...
  <div class="auth-page">
    <div class="form-wrap">
      ...
      <form @submit.prevent="submit">
        <div class="field">
          <label>用户名</label>
          <el-input v-model="form.username" placeholder="取一个用户名" size="large" />
        </div>
        <div class="field">
          <label>密码</label>
        ...
        <div class="field">
          <label>学校</label>
          <el-input v-model="form.school" placeholder="选填" size="large" />
        </div>
...
const form = reactive({ username: '', password: '', email: '', school: '' })
